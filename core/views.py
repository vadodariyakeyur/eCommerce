...
class CheckoutView(LoginRequiredMixin, View):
    ...
    def get(self, *args, **kwargs):
        try:
            ...
            messages.warning("You don't have an active order")
        ...
        try:
            ...
            if form.is_valid():
                ...
                if payment_option == 'S':
                    ...
                    messages.warning("Invalid Payment option Selected")
                    return redirect('core:checkout')
...
def remove_from_cart(request, slug):
    ...
    if order_qs.exists():
        ...
        if order.items.filter(item__slug=item.slug).exists():
            ...
            # add a message that order doesn't contain that order item
            messages.info(request, "This Item was not in your cart.")
            return redirect('core:product', slug=slug)
    else:
        # add a message that user doesnt have a order
    ...
    def post(self, *args, **kwargs):
        ...
        if form.is_valid():
            ...
            try:
                ...
                refund.save()
                messages.info(
                    self.request, "Your Refund Request has been recieved")
